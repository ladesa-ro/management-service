import { OfertaFormacaoEntity } from "@/integrations/database/typeorm/entities/04-ensino-institucional";
...
export class CalendarioLetivoEntity implements IDomainContracts.CalendarioLetivo {
  ...
  campus!: IDomainContracts.Campus;
