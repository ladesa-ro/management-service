...
import { NivelFormacaoService } from "@/features/nivel-formacao/domain/nivel-formacao.service";
...
import type { OfertaFormacaoNivelFormacaoEntity } from "@/infrastructure-antigo/integrations/database/typeorm/entities";
