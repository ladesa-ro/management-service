...
import { ModalidadeService } from "@/features/modalidade/domain/modalidade.service";
...
import type { OfertaFormacaoEntity } from "@/infrastructure-antigo/integrations/database/typeorm/entities";
...
export class OfertaFormacaoService {
  ...
  async ofertaFormacaoUpdate(accessContext: AccessContext, domain: IDomain.OfertaFormacaoFindOneInput & IDomain.OfertaFormacaoUpdateInput) {
    // =========================================================
