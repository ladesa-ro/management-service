...
export class DisponibilidadeDiaController {
  ...
  @Get("/:id")
  async disponibilidadeDiaFindById(@AccessContextHttp() accessContext: AccessContext, @AppRequest("DisponibilidadeDiaFindById") dto: IAppRequest<"DisponibilidadeDiaFindOneById">) {
    return this.disponibilidadeDiaService.disponibilidadeDiaFindByIdStrict(accessContext, {id: dto.path.id});
  }

  @Post("/")
  async disponibilidadeDiaCreate(@AccessContextHttp() accessContext: AccessContext, @AppRequest("DisponibilidadeDiaCreate") dto: IAppRequest<"DisponibilidadeDiaCreate">) {
  ...
  @Patch("/:id")
  async disponibilidadeDiaUpdate(@AccessContextHttp() accessContext: AccessContext, @AppRequest("DisponibilidadeDiaUpdate") dto: IAppRequest<"DisponibilidadeDiaUpdateOneById">) {
  ...
  @Delete("/:id")
  async disponibilidadeDiaDeleteOneById(@AccessContextHttp() accessContext: AccessContext, @AppRequest("DisponibilidadeDiaDeleteOneById") dto: IAppRequest<"DisponibilidadeDiaDeleteOneById">) {
