...
import type { DisponibilidadeDiaEntity } from "@ladesa-ro/management-management-service.infrastructure/integrations/database/typeorm/entities";
...
export class DisponibilidadeDiaService {
  ...
  async disponibilidadeDiaFindAll(
    ...
    dto: IDomainContracts.DisponibilidadeDiaListInput | null = null,
    ...
    qb.select([]);
    QbEfficientLoad(
      IDomainContracts.Tokens.DisponibilidadeDiaFindOneOutput,
      qb,
      aliasDisponibilidadeDia,
      selection
    );
  ...
  async disponibilidadeDiaFindById(
    ...
    selection?: string[] | boolean
  ): Promise<IDomainContracts.DisponibilidadeDiaFindOneOutput | null> {
    // =========================================================
  ...
  async disponibilidadeDiaFindByIdSimple(
    accessContext: AccessContext,
    id: IDomainContracts.DisponibilidadeDiaFindOneInput["id"],
    selection?: string[]
  ): Promise<IDomainContracts.DisponibilidadeDiaFindOneOutput | null> {
    // =========================================================
