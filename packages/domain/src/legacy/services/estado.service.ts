...
export class EstadoService {
  ...
  async findAll(accessContext: AccessContext, dto: IDomainContracts.EstadoListInput | null = null, selection?: string[]): Promise<IDomainContracts.EstadoListOperationOutput["success"]> {
    // =========================================================
  ...
  async findById(accessContext: AccessContext, dto: IDomainContracts.EstadoFindOneInput, selection?: string[]) {
    // =========================================================
  ...
  async findByIdStrict(accessContext: AccessContext, dto: IDomainContracts.EstadoFindOneInput, selection?: string[]) {
