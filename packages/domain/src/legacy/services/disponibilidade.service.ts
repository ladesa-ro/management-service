...
import type { DisponibilidadeEntity } from "@ladesa-ro/management-management-service.infrastructure/integrations/database/typeorm/entities";
...
export class DisponibilidadeService {
  ...
  async disponibilidadeFindAll(
    ...
    dto: IDomainContracts.DisponibilidadeListInput | null = null,
    selection?: string[],
  ...
  async disponibilidadeFindById(
    ...
    selection?: string[],
  ): Promise<IDomainContracts.DisponibilidadeFindOneOutput | null> {
    // =========================================================
  ...
  async disponibilidadeFindByIdStrict(accessContext: AccessContext, dto: IDomainContracts.DisponibilidadeFindOneInput, selection?: string[]) {
  ...
  async disponibilidadeFindByIdSimple(
    accessContext: AccessContext,
    id: IDomainContracts.DisponibilidadeFindOneInput["id"],
    selection?: string[],
  ): Promise<IDomainContracts.DisponibilidadeFindOneOutput | null> {
    // =========================================================
  ...
  async disponibilidadeFindByIdSimpleStrict(accessContext: AccessContext, id: IDomainContracts.DisponibilidadeFindOneInput["id"], selection?: string[]) {
  ...
  async disponibilidadeCreate(accessContext: AccessContext, dto: IDomainContracts.DisponibilidadeCreateInput) {
    // =========================================================
  ...
  async disponibilidadeUpdate(accessContext: AccessContext, dto: IDomainContracts.DisponibilidadeUpdateInput) {
    // =========================================================
  ...
  async disponibilidadeDeleteOneById(accessContext: AccessContext, dto: IDomainContracts.DisponibilidadeFindOneInput) {
    // =========================================================
