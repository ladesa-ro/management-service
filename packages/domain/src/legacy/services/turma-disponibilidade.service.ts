...
import type { TurmaDisponibilidadeEntity } from "@ladesa-ro/management-management-service.infrastructure/integrations/database/typeorm/entities";
...
export class TurmaDisponibilidadeService {
  ...
  async turmaDisponibilidadeFindAll(
    ...
    dto: IDomainContracts.TurmaDisponibilidadeListInput | null = null,
    selection?: string[]
  ...
  async turmaDisponibilidadeFindById(
    ...
    selection?: string[]
  ): Promise<IDomainContracts.TurmaDisponibilidadeFindOneOutput | null> {
    // =========================================================
  ...
  async turmaDisponibilidadeFindByIdSimple(
    accessContext: AccessContext,
    id: IDomainContracts.TurmaDisponibilidadeFindOneInput["id"],
    selection?: string[]
  ): Promise<IDomainContracts.TurmaDisponibilidadeFindOneOutput | null> {
    // =========================================================
