...
import type { CampusEntity } from "@ladesa-ro/management-management-service.infrastructure/integrations/database/typeorm/entities";
...
export class CampusService {
  ...
  async campusFindAll(
    ...
    dto: IDomainContracts.CampusListInput | null = null,
    ...
    qb.select([]);
    QbEfficientLoad(IDomainContracts.Tokens.CampusFindOneOutput, qb, aliasCampus, selection);
  ...
  async campusFindById(accessContext: AccessContext, dto: IDomainContracts.CampusFindOneInput, selection?: string[] | boolean): Promise<IDomainContracts.CampusFindOneOutput | null> {
    // =========================================================
  ...
  async campusFindByIdStrict(accessContext: AccessContext, dto: IDomainContracts.CampusFindOneInput, selection?: string[] | boolean) {
  ...
  async campusFindByIdSimple(accessContext: AccessContext, id: IDomainContracts.CampusFindOneInput["id"], selection?: string[] | boolean): Promise<IDomainContracts.CampusFindOneOutput | null> {
    // =========================================================
  ...
  async campusFindByIdSimpleStrict(accessContext: AccessContext, id: IDomainContracts.CampusFindOneInput["id"], selection?: string[] | boolean) {
  ...
  async campusCreate(accessContext: AccessContext, dto: IDomainContracts.CampusCreateInput) {
    // =========================================================
  ...
  async campusUpdate(accessContext: AccessContext, dto: IDomainContracts.CampusUpdateInput) {
    // =========================================================
  ...
  async campusDeleteOneById(accessContext: AccessContext, dto: IDomainContracts.CampusFindOneInput) {
    // =========================================================
