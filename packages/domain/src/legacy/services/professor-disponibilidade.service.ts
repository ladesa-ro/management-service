...
import type { ProfessorDisponibilidadeEntity } from "@ladesa-ro/management-management-service.infrastructure/integrations/database/typeorm/entities";
...
export class ProfessorDisponibilidadeService {
  ...
  async professorDisponibilidadeFindAll(
    ...
    dto: IDomainContracts.ProfessorDisponibilidadeListInput | null = null,
    selection?: string[]
  ): Promise<
  ...
  async professorDisponibilidadeFindById(
    ...
    selection?: string[]
  ): Promise<IDomainContracts.ProfessorDisponibilidadeFindOneOutput | null> {
    // =========================================================
  ...
  async professorDisponibilidadeFindByIdSimple(
    accessContext: AccessContext,
    id: IDomainContracts.ProfessorDisponibilidadeFindOneInput["id"],
    selection?: string[]
  ): Promise<IDomainContracts.ProfessorDisponibilidadeFindOneOutput | null> {
    // =========================================================
