...
import type { UsuarioEntity } from "@ladesa-ro/management-management-service.infrastructure/integrations/database/typeorm/entities";
import { KeycloakService } from "@ladesa-ro/management-management-service.infrastructure/integrations/identity-provider";
...
export class UsuarioService {
  ...
  async internalFindByMatriculaSiape(matriculaSiape: string, selection?: string[] | boolean): Promise<IDomainContracts.UsuarioFindOneOutput | null> {
    // =========================================================
    ...
    qb.select([]);
    QbEfficientLoad(IDomainContracts.Tokens.UsuarioFindOneOutput, qb, aliasUsuario, selection);
    // =========================================================
  ...
  async usuarioFindAll(
    ...
    dto: IDomainContracts.UsuarioListInput | null = null,
  ...
  async usuarioFindById(accessContext: AccessContext | null, dto: IDomainContracts.UsuarioFindOneInput, selection?: string[] | boolean): Promise<IDomainContracts.UsuarioFindOneOutput | null> {
    // =========================================================
  ...
  async usuarioFindByIdStrict(accessContext: AccessContext | null, dto: IDomainContracts.UsuarioFindOneInput, selection?: string[] | boolean) {
  ...
  async usuarioFindByIdSimple(accessContext: AccessContext, id: IDomainContracts.UsuarioFindOneInput["id"], selection?: string[]): Promise<IDomainContracts.UsuarioFindOneOutput | null> {
    // =========================================================
  ...
  async usuarioFindByIdSimpleStrict(accessContext: AccessContext, id: IDomainContracts.UsuarioFindOneInput["id"], selection?: string[]) {
  ...
  private async ensureDtoAvailability(dto: Partial<Pick<IDomainContracts.Usuario, "email" | "matriculaSiape">>, currentUsuarioId: string | null = null) {
    // ===================================
  ...
  async usuarioUpdateImagemCapa(accessContext: AccessContext, dto: IDomainContracts.UsuarioFindOneInput, file: Express.Multer.File) {
    // =========================================================
  ...
  async usuarioUpdateImagemPerfil(accessContext: AccessContext, dto: IDomainContracts.UsuarioFindOneInput, file: Express.Multer.File) {
    // =========================================================
  ...
  async usuarioCreate(accessContext: AccessContext, dto: IDomainContracts.UsuarioCreateInput) {
    // =========================================================
  ...
  async usuarioUpdate(accessContext: AccessContext, dto: IDomainContracts.UsuarioUpdateInput) {
    // =========================================================
  ...
  async usuarioDeleteOneById(accessContext: AccessContext, dto: IDomainContracts.UsuarioFindOneInput) {
    // =========================================================
