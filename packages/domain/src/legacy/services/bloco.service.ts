...
import type { BlocoEntity } from "@ladesa-ro/management-management-service.infrastructure/integrations/database/typeorm/entities";
...
export class BlocoService {
  ...
  async blocoFindAll(
    ...
    dto: IDomainContracts.BlocoListInput | null = null,
    ...
    qb.select([]);
    QbEfficientLoad(IDomainContracts.Tokens.BlocoFindOneOutput, qb, aliasBloco, selection);
  ...
  async blocoFindById(accessContext: AccessContext | null, dto: IDomainContracts.BlocoFindOneInput, selection?: string[] | boolean): Promise<IDomainContracts.BlocoFindOneOutput | null> {
    // =========================================================
  ...
  async blocoFindByIdStrict(accessContext: AccessContext | null, dto: IDomainContracts.BlocoFindOneInput, selection?: string[] | boolean) {
  ...
  async blocoFindByIdSimple(accessContext: AccessContext, id: IDomainContracts.BlocoFindOneInput["id"], selection?: string[]): Promise<IDomainContracts.BlocoFindOneOutput | null> {
    // =========================================================
  ...
  async blocoFindByIdSimpleStrict(accessContext: AccessContext, id: IDomainContracts.BlocoFindOneInput["id"], selection?: string[]) {
  ...
  async blocoUpdateImagemCapa(accessContext: AccessContext, dto: IDomainContracts.BlocoFindOneInput, file: Express.Multer.File) {
    // =========================================================
  ...
  async blocoCreate(accessContext: AccessContext, dto: IDomainContracts.BlocoCreateInput) {
    // =========================================================
  ...
  async blocoUpdate(accessContext: AccessContext, dto: IDomainContracts.BlocoUpdateInput) {
    // =========================================================
  ...
  async blocoDeleteOneById(accessContext: AccessContext, dto: IDomainContracts.BlocoFindOneInput) {
    // =========================================================
