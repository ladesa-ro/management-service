...
import type { DiarioEntity } from "@ladesa-ro/management-management-service.infrastructure/integrations/database/typeorm/entities";
...
export class DiarioService {
  ...
  async diarioFindAll(
    ...
    dto: IDomainContracts.DiarioListInput | null = null,
    ...
    qb.select([]);
    QbEfficientLoad(
      IDomainContracts.Tokens.DiarioFindOneOutput,
      qb,
      aliasDiario,
      selection
    );
  ...
  async diarioFindById(
    ...
    selection?: string[] | boolean
  ): Promise<IDomainContracts.DiarioFindOneOutput | null> {
    // =========================================================
  ...
  async diarioFindByIdSimple(
    accessContext: AccessContext,
    id: IDomainContracts.DiarioFindOneInput["id"],
    selection?: string[] | boolean
  ): Promise<IDomainContracts.DiarioFindOneOutput | null> {
    // =========================================================
