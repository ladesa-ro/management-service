...
export type GenericListInput = {
  queries: IDomainContracts.GenericSearchInput;
};
...
export class PaginateQueryAdapter {
  static FromGenericListInput(path: string, genericListInput: GenericListInput | null): PaginateQuery {
    const inputQueries = genericListInput?.queries;
