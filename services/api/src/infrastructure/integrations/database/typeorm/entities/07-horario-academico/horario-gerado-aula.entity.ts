...
export class HorarioGeradoAulaEntity implements IDomainContracts.HorarioGeradoAula {
  ...
  diarioProfessor!: IDomainContracts.DiarioProfessor;

  @ManyToOne(() => HorarioGeradoEntity)
  @JoinColumn({ name: "id_horario_gerado_fk" })
  horarioGerado!: IDomainContracts.HorarioGerado;
