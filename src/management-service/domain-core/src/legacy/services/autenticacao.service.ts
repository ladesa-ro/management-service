...
import { KeycloakService, OpenidConnectService } from "@ladesa-ro/management-management-service.infrastructure/integrations/identity-provider";
...
export class AutenticacaoService {
  ...
  async login(accessContext: AccessContext, dto: IDomainContracts.AuthLoginInput): Promise<IDomainContracts.AuthLoginOperationOutput["success"]> {
  ...
  async refresh(_: AccessContext, dto: IDomainContracts.AuthRefreshInput): Promise<IDomainContracts.AuthLoginOperationOutput["success"]> {
    let config: client.Configuration;
  ...
  async recoverPassword(_accessContext: AccessContext | null, dto: IDomainContracts.AuthRecoverPasswordInput) {
    const kcAdminClient = await this.keycloakService.getAdminClient();
