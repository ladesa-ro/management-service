...
export class CidadeService {
  ...
  async findAll(accessContext: AccessContext, dto: IDomainContracts.CidadeListInput | null = null, selection?: string[]) {
    // =========================================================
  ...
  async findById(accessContext: AccessContext, dto: IDomainContracts.CidadeFindOneInput, selection?: string[]) {
    // =========================================================
  ...
  async findByIdStrict(accessContext: AccessContext, dto: IDomainContracts.CidadeFindOneInput, selection?: string[]) {
