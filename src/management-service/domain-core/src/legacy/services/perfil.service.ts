...
export class PerfilService {
  ...
  async perfilGetAllActive(accessContext: AccessContext | null, usuarioId: UsuarioEntity["id"]) {
    ...
    QbEfficientLoad(IDomainContracts.Tokens.PerfilFindOneOutput, qb, "vinculo");
  ...
  async perfilFindAll(accessContext: AccessContext, dto: IDomainContracts.PerfilListInput | null = null, selection?: string[] | boolean) {
    const qb = this.vinculoRepository.createQueryBuilder(aliasVinculo);

    QbEfficientLoad(IDomainContracts.Tokens.PerfilFindOneOutput, qb, aliasVinculo, selection);
  ...
  async perfilFindById(accessContext: AccessContext, dto: IDomainContracts.PerfilFindOneInput, selection?: string[] | boolean): Promise<IDomainContracts.PerfilFindOneOutput | null> {
    // =========================================================
  ...
  async perfilFindByIdStrict(accessContext: AccessContext, dto: IDomainContracts.PerfilFindOneInput, selection?: string[] | boolean) {
  ...
  async perfilSetVinculos(accessContext: AccessContext, dto: IDomainContracts.PerfilUpdateInput) {
