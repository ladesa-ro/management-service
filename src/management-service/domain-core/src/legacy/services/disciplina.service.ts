...
import type { DisciplinaEntity } from "@ladesa-ro/management-management-service.infrastructure/integrations/database/typeorm/entities";
...
export class DisciplinaService {
  ...
  async disciplinaFindAll(
    ...
    dto: IDomainContracts.DisciplinaListInput | null = null,
    ...
    qb.select([]);
    QbEfficientLoad(
      IDomainContracts.Tokens.DisciplinaFindOneOutput,
      qb,
      aliasDisciplina,
      selection
    );
  ...
  async disciplinaFindById(
    ...
    selection?: string[] | boolean
  ): Promise<IDomainContracts.DisciplinaFindOneOutput | null> {
    // =========================================================
  ...
  async disciplinaFindByIdSimple(
    accessContext: AccessContext,
    id: IDomainContracts.DisciplinaFindOneInput["id"],
    selection?: string[] | boolean
  ): Promise<IDomainContracts.DisciplinaFindOneOutput | null> {
    // =========================================================
