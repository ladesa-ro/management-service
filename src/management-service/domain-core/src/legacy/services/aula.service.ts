...
import type { AulaEntity } from "@ladesa-ro/management-management-service.infrastructure/integrations/database/typeorm/entities";
...
export class AulaService {
  ...
  async aulaFindAll(
    ...
    dto: IDomainContracts.AulaListInput | null = null,
    ...
    qb.select([]);
    QbEfficientLoad(
      IDomainContracts.Tokens.AulaFindOneOutput,
      qb,
      aliasAula,
      selection
    );
  ...
  async aulaFindById(
    ...
    selection?: string[] | boolean
  ): Promise<IDomainContracts.AulaFindOneOutput | null> {
    // =========================================================
  ...
  async aulaFindByIdSimple(
    accessContext: AccessContext,
    id: IDomainContracts.AulaFindOneInput["id"],
    selection?: string[] | boolean
  ): Promise<IDomainContracts.AulaFindOneOutput | null> {
    // =========================================================
