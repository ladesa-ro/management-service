import { NivelFormacaoEntity } from "@/integrations/database/typeorm/entities/04-ensino-institucional/nivel-formacao.entity";
...
export class OfertaFormacaoNivelFormacaoEntity implements IDomainContracts.OfertaFormacaoNivelFormacao {
  ...
  nivelFormacao!: IDomainContracts.NivelFormacao;

  @ManyToOne(() => OfertaFormacaoEntity)
  @JoinColumn({ name: "id_oferta_formacao_fk" })
  ofertaFormacao!: IDomainContracts.OfertaFormacao;
