...
import { Disponibilidade, type IDisponibilidade } from "@/modules/ensino/disponibilidade";
import type {
...
} from "@/modules/ensino/disponibilidade/application/dtos";
import {
  DISPONIBILIDADE_REPOSITORY_PORT,
  type IDisponibilidadeRepositoryPort,
  type IDisponibilidadeUseCasePort,
} from "@/modules/ensino/disponibilidade/application/ports";
