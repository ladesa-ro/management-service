...
} from "@/Ladesa.Management.Server.Api/Apis/Rest/Dtos/CalendarioLetivoRestDto";
import { EventoFieldsMixin } from "@/Ladesa.Management.Server.Api/Validation/EventoValidationMixin";
