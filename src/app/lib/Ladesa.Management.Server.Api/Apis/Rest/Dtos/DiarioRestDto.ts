...
import {
  ...
  TransformToArray,
} from "@/Ladesa.Management.Server.Api/Apis/Rest/Abstractions";
import {
  AmbienteFindOneInputRestDto,
  AmbienteFindOneOutputRestDto,
} from "@/Ladesa.Management.Server.Api/Apis/Rest/Dtos/AmbienteRestDto";
import { ImagemFindOneOutputRestDto } from "@/Ladesa.Management.Server.Api/Apis/Rest/Dtos/BlocoRestDto";
import { CalendarioLetivoFindOneOutputRestDto } from "@/Ladesa.Management.Server.Api/Apis/Rest/Dtos/CalendarioLetivoRestDto";
import {
  DisciplinaFindOneInputRestDto,
  DisciplinaFindOneOutputRestDto,
} from "@/Ladesa.Management.Server.Api/Apis/Rest/Dtos/DisciplinaRestDto";
import {
  TurmaFindOneInputRestDto,
  TurmaFindOneOutputRestDto,
} from "@/Ladesa.Management.Server.Api/Apis/Rest/Dtos/TurmaRestDto";
import { DiarioFieldsMixin } from "@/Ladesa.Management.Server.Api/Validation/DiarioValidationMixin";
