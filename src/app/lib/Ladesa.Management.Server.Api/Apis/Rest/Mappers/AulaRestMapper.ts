...
} from "@/Ladesa.Management.Server.Api/Apis/Rest/Dtos/AulaRestDto";
...
import { IntervaloDeTempoRestMapper } from "@/Ladesa.Management.Server.Api/Apis/Rest/Mappers/IntervaloDeTempoRestMapper";
