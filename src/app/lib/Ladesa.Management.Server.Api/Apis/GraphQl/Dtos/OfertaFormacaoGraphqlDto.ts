...
import { ModalidadeFindOneOutputGraphQlDto } from "@/Ladesa.Management.Server.Api/Apis/GraphQl/Dtos/ModalidadeGraphqlDto";
import { OfertaFormacaoFieldsMixin } from "@/Ladesa.Management.Server.Api/Validation/OfertaFormacaoValidationMixin";
