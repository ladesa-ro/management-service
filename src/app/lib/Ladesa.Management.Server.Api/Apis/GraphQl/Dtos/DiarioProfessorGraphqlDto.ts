...
import { PerfilFindOneOutputGraphQlDto } from "@/Ladesa.Management.Server.Api/Apis/GraphQl/Dtos/PerfilGraphqlDto";
import { DiarioProfessorFieldsMixin } from "@/Ladesa.Management.Server.Api/Validation/DiarioProfessorValidationMixin";
