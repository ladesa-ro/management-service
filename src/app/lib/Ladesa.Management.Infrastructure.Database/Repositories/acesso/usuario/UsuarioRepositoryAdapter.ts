...
import type { UsuarioEntity } from "@/Ladesa.Management.Application/acesso/usuario/infrastructure/persistence/typeorm/usuario.entity";
...
import { createCursoRepository } from "@/Ladesa.Management.Infrastructure.Database/TypeOrmNew/Repositories/ensino/curso/curso.repository";
