...
import type { Evento } from "@/Ladesa.Management.Application/horarios/evento";
import type {
 ...
 */
export const IEventoRepository = Symbol("IEventoRepository");
...
export interface IEventoRepository {
   ...
   */
  createFromDomain(data: Evento): Promise<{ id: string | number }>;

  /**
   * Atualiza uma entidade a partir de dados de domínio parciais
   */
  updateFromDomain(id: string | number, data: Partial<Evento>): Promise<void>;
