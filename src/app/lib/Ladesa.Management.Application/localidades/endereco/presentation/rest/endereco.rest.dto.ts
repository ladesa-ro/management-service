...
import { EntityBaseRestDto } from "@/Ladesa.Management.Application/@shared/infrastructure/presentation/rest/dtos";
import {
  CidadeFindOneInputRestDto,
  CidadeFindOneOutputRestDto,
} from "@/Ladesa.Management.Application/localidades/cidade/presentation/rest/cidade.rest.dto";
import {
  commonProperties,
  RegisterModel,
  referenceProperty,
