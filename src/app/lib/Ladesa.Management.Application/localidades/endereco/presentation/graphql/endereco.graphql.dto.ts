...
import { EntityBaseGraphQlDto } from "@/Ladesa.Management.Application/@shared/infrastructure/graphql/dtos";
import {
  CidadeFindOneInputGraphQlDto,
  CidadeFindOneOutputGraphQlDto,
} from "@/Ladesa.Management.Application/localidades/cidade/presentation/graphql/cidade.graphql.dto";
