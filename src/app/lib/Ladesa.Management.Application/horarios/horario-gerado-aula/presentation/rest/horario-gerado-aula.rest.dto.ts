...
} from "@/Ladesa.Management.Application/ensino/diario-professor/presentation/rest";
import {
  HorarioGeradoFindOneInputRestDto,
  HorarioGeradoFindOneOutputRestDto,
} from "@/Ladesa.Management.Application/horarios/horario-gerado/presentation/rest";
import {
  IntervaloDeTempoFindOneInputRestDto,
  IntervaloDeTempoFindOneOutputRestDto,
} from "@/Ladesa.Management.Application/horarios/intervalo-de-tempo/presentation/rest/intervalo-de-tempo.rest.dto";
import {
  commonProperties,
  RegisterModel,
  referenceProperty,
