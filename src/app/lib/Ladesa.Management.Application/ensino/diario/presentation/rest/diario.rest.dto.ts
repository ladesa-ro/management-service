...
} from "@/Ladesa.Management.Application/ambientes/ambiente/presentation/rest";
import { ImagemFindOneOutputRestDto } from "@/Ladesa.Management.Application/ambientes/bloco/presentation/rest";
import { DiarioFieldsMixin } from "@/Ladesa.Management.Application/ensino/diario/presentation/diario.validation-mixin";
import {
  DisciplinaFindOneInputRestDto,
  DisciplinaFindOneOutputRestDto,
} from "@/Ladesa.Management.Application/ensino/disciplina/presentation/rest";
import {
  TurmaFindOneInputRestDto,
  TurmaFindOneOutputRestDto,
} from "@/Ladesa.Management.Application/ensino/turma/presentation/rest";
import { CalendarioLetivoFindOneOutputRestDto } from "@/Ladesa.Management.Application/horarios/calendario-letivo/presentation/rest";
import {
  commonProperties,
  RegisterModel,
  referenceProperty,
