...
export const ConfigTokensMap = new Map<symbol, string>([
  ...
  [ConfigTokens.QueueOptions.Url, EnvKeys.QUEUE_DATABASE_URL],
  [ConfigTokens.QueueOptions.Schema, EnvKeys.QUEUE_SCHEMA],
  [ConfigTokens.QueueOptions.QueueTimetableGenerate, EnvKeys.QUEUE_TIMETABLE_GENERATE],
  [ConfigTokens.QueueOptions.QueueFolhaPontoWhatsapp, EnvKeys.QUEUE_FOLHA_PONTO_WHATSAPP],
