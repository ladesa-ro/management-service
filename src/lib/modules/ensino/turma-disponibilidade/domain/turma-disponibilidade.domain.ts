...
import type { Disponibilidade } from "@/modules/ensino/disponibilidade/domain/disponibilidade.domain";
import type { Turma } from "@/modules/ensino/turma/domain/turma.domain";
import type {
