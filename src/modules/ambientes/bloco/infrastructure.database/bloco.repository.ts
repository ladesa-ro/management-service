...
import type { BlocoEntity } from "./typeorm/bloco.typeorm.entity";
import { createBlocoRepository } from "./typeorm/bloco.typeorm.repository";
  ...
  implements IBlocoRepository
{
  ...
  protected get repository() {
    return createBlocoRepository(this.appTypeormConnection);
  }
