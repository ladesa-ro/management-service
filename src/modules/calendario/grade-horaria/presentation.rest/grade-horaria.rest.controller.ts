...
} from "@/modules/calendario/grade-horaria/domain/commands/grade-horaria-replace.command.handler.interface";
import {
  GradeHorariaFindByCampusQueryMetadata,
  IGradeHorariaFindByCampusQueryHandler,
} from "@/modules/calendario/grade-horaria/domain/queries/grade-horaria-find-by-campus.query.handler.interface";
