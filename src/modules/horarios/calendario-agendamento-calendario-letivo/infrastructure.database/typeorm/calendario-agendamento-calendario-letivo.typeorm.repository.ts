...
export const createCalendarioAgendamentoCalendarioLetivoRepository = createRepositoryFactory(
  (ds) => {
    return ds.getRepository(CalendarioAgendamentoCalendarioLetivoEntity).extend({});
  },
);

export type CalendarioAgendamentoCalendarioLetivoRepository = IRepositoryFactoryOutput<
  typeof createCalendarioAgendamentoCalendarioLetivoRepository
>;
