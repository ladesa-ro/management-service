...
export const ImagemArquivoPaginationInputSchema = createPaginationInputSchema();

export const ImagemArquivoGraphqlListInputSchema = createGraphqlListInputSchema();
