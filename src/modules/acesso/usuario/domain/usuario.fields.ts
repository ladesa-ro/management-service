...
export const UsuarioFields = {
  nome: createFieldMetadata({
    ...
    schema: createSchema(() =>
      z.string().min(1, "nome deve ter pelo menos 1 caractere").nullable().optional(),
    ),
    nullable: true,
  }),
  matricula: createFieldMetadata({
    ...
    schema: createSchema(() =>
      z.string().min(1, "matrícula deve ter pelo menos 1 caractere").nullable().optional(),
    ),
    nullable: true,
  }),
  email: createFieldMetadata({
    description: "E-mail do usuario",
    schema: createSchema(() => z.string().email("email inválido").nullable().optional()),
    nullable: true,
  }),
