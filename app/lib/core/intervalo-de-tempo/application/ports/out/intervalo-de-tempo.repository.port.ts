...
export interface IIntervaloDeTempoRepositoryPort {
  findAll(accessContext: AccessContext, dto: IntervaloDeTempoListInput | null): Promise<IntervaloDeTempoListOutput>;
  findById(accessContext: AccessContext | null, dto: IntervaloDeTempoFindOneInput): Promise<IntervaloDeTempoFindOneOutput | null>;
