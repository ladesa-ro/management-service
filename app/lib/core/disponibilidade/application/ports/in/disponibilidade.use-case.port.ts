...
export interface IDisponibilidadeUseCasePort {
  ...
  findByIdStrict(accessContext: AccessContext, dto: DisponibilidadeFindOneInput): Promise<DisponibilidadeFindOneOutput>;
  create(accessContext: AccessContext, dto: DisponibilidadeCreateInput): Promise<DisponibilidadeFindOneOutput>;
  update(accessContext: AccessContext, dto: DisponibilidadeFindOneInput & DisponibilidadeUpdateInput): Promise<DisponibilidadeFindOneOutput>;
  ...
  disponibilidadeFindByIdSimpleStrict(accessContext: AccessContext, id: string): Promise<DisponibilidadeFindOneOutput>;
}
