...
export class GerarHorarioRestController {
  ...
  @Get("/poc")
  @ApiOperation({
    summary: "POC: Publica na queue dev.timetable_generate.request e aguarda resposta em dev.timetable_generate.response",
  ...
  async poc(): Promise<ServiceGenerateResponse> {
    ...
    return this.gerarHorarioService.publishTimetableRequest<GenerateRequest, ServiceGenerateResponse>(request);
  }
}
