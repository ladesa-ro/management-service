...
export type IBaseAuthzCheckFn<Action extends string, Payload> = (
...
export type IBaseAuthzFilterFn<Action extends string, Payload> = (
  context: IBaseAuthzStatementContext<Action, Payload>,
  alias?: string,
