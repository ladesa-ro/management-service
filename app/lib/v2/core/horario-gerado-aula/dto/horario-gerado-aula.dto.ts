...
import { IsUUID, IsDateString, IsOptional, IsArray, IsString, ValidateNested } from "class-validator";
...
import { DiarioProfessorFindOneOutputDto, DiarioProfessorFindOneInputDto } from "@/v2/core/diario-professor/dto";
import { HorarioGeradoFindOneOutputDto, HorarioGeradoFindOneInputDto } from "@/v2/core/horario-gerado/dto";
