...
import { IsUUID, IsDateString, IsOptional, IsArray, IsString } from "class-validator";
...
export class DisponibilidadeListOutputDto {
  ...
  @ApiProperty({ type: () => [DisponibilidadeFindOneOutputDto], description: "Resultados da busca" })
