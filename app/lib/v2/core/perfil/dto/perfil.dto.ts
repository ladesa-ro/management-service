...
import { IsUUID, IsString, MinLength, IsDateString, IsOptional, IsArray, IsBoolean, ValidateNested } from "class-validator";
...
import { UsuarioFindOneOutputDto, UsuarioFindOneInputDto } from "@/v2/core/usuario/dto";
