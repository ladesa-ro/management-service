...
import { IsUUID, IsString, IsInt, IsOptional, Min, Max, IsDateString, ValidateNested } from "class-validator";
...
import { CidadeFindOneOutputDto, CidadeFindOneInputDto } from "@/v2/core/cidade/dto";
