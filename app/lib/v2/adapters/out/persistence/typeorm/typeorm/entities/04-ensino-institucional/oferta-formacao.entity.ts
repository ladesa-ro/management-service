...
import {
  ModalidadeEntity
} from "@/v2/adapters/out/persistence/typeorm/typeorm/entities/04-ensino-institucional/modalidade.entity";
import {
  OfertaFormacaoNivelFormacaoEntity
} from "@/v2/adapters/out/persistence/typeorm/typeorm/entities/04-ensino-institucional/oferta-formacao-nivel-formacao.entity";
