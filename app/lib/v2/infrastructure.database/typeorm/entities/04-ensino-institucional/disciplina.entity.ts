...
import { ImagemEntity } from "@/v2/infrastructure.database/typeorm/entities/00-00-base";
import { DiarioEntity } from "@/v2/infrastructure.database/typeorm/entities/06-ensino-discente";
